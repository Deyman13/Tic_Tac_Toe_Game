...
>### 2. Даниил Шкляев
---
## *Проект был создан с целью обучения создания Telegram Bot*
---
## *Основная идея проекта - создание бота для игры в крестики-нолики*
---
# **Наш бот настроен на игру против пользователя и имеет множество интересных особенностей, таких как:**
## ***Рейтинг и его изменение для каждого пользователя***
>---
>- ### Статистика побед и поражений пользователя
>---
## ***Жеребьевка первого хода и вариации бота для игры против пользователя***
>---
...
>---
## ***Таблица с информацией о текущем сеансе игры***
>---
