# <font color='#E34234'>***Проект: Крестики нолики***</font>
![](images/4827.gif)
---
># [Ссылка на Telegram Bot](https://t.me/Tic_Tac_Toee_Smart_Bot)
>### Бот будет активен всегда, так как находится на хостинге

## <font color='#F984E5'>**В данном проекте участие принимали два человека.**</font>
>### 1. <font color='#ABCDEF'>Борис Лукашенок</font>

>### 2. <font color='#ABCDEF'>Даниил Шкляев</font>
---
## <font color='#F984E5'>*Проект был создан с целью обучения создания Telegram Bot*</font>
---
## <font color='#F984E5'>*Основная идея проекта - создание бота для игры в крестики-нолики*</font>
---
# <font color='#F984E5'>**Наш бот настроен на игру против пользователя и имеет множество интересных особенностей, таких как:**</font>
## <font color='#FFCF40'>***Рейтинг и его изменение для каждого пользователя***</font>
>---
>- ### Статистика побед и поражений пользователя
>---
## <font color='#FFCF40'>***Жеребьевка первого хода и вариации бота для игры против пользователя***</font>
>---
...
>---
## <font color='#FFCF40'>***Таблица с информацией о текущем сеансе игры***</font>
>---
>- #### Рейтинг с победами и поражениями пользователя
>- #### Приветствие при старте игры
>- #### Информация о том, какой бот был активирован
>- #### Вежливое пожелание "Приятной игры"
>- #### Просьба не жульничать при попытке пользователя наступить на уже занятую ячейку
>- #### Побуждение к действиям после хода бота
>- #### И самое главное - результат финала игры. Победа, ничья или же поражение
>---
## <font color='#FFCF40'>***Дизайн оформленный в стиле Нового Года***</font>
>---
>- ### ***Для необходимого нам оформления использована библиотека [EMOJI](https://pypi.org/project/emoji/)***
>1. #### В качестве пустых ячеек мы использовали подарочные коробочки
>2. #### В качестве символов пользователя использованы снежинки
>2. #### А бот ходит символами-звездочками
>---
---
# <font color='#F984E5'>***Перейдем к демонстрации того, как выглядит непосредственно в Telegram процесс игры.***</font>
---
