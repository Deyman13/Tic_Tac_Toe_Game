## Привет!
### Этот проект включает в себя Telegram_Bot для:
>- ### Игры в крестики-нолики 

>- ### Использования калькулятора

>- ### Использования справочника
---

### Pet-project - Tic-Tac-Toe. В него вложены все возможные усилия, и соответственно о нем и будет речь, так как калькулятор и справочник - лишь мини-версии.
---
## В данном проекте участие принимали 2 человека. 
>### 1. Борис Лукашенок
